...
def generate_launch_description():
    ...
    gz_bridge = Node(
        ...
        arguments=[
            ...
            '/world/pigs/model/kinect_v2_standalong/link/root/sensor/kinect_v2_ir_sensor/depth_image@sensor_msgs/msg/Image[ignition.msgs.Image',
        ...
        remappings=[
            ('/world/pigs/model/kinect_v2_standalong/link/root/sensor/kinect_v2_ir_sensor/depth_image', 
